import { BaseMetric, EnvironmentalMetric, environmentalMetricMap, metricsIndex, TemporalMetric, temporalMetricMap } from './models';
...
export const calculateMImpact = (metricsMap, miss, versionStr) => metricsMap.get(EnvironmentalMetric.SCOPE) === 'U'
    ? 6.42 * miss
    : 7.52 * (miss - 0.029) -
...
export const populateUndefinedMetrics = (metricsMap) => {
